...
- Waste display in shopping list: `waste = ceil(total/perPkg − ε)*perPkg − total` (the `−ε` avoids a float-ceil buying an extra unit). "⚠️ ½ can unused". Skipped for `longShelfLife` / `acceptableWaste` / `nonWaste`.
...
## Current State (2026-07-09, V235 — `main` @ tip)
