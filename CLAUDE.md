...
## Current State (2026-07-11, V261 — `main` @ tip)
...
- **Branch tip**: `MP_2026-07-11_V9` == `main` (V261). Convention: every commit gets an `MP_<date>_V<N>` branch AND `main` fast-forwarded to it; push both immediately.
