...
## Current State (2026-07-11, V255 — `main` @ tip)
...
- **Branch tip**: `MP_2026-07-11_V3` == `main` (V255). Convention: every commit gets an `MP_<date>_V<N>` branch AND `main` fast-forwarded to it; push both immediately.
