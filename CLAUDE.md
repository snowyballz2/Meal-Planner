...
## Current State (2026-07-10, V252 — `main` @ tip)
...
- **Branch tip**: `MP_2026-07-10_V15` == `main` (V252). Convention: every commit gets an `MP_<date>_V<N>` branch AND `main` fast-forwarded to it; push both immediately.
