...
## Current State (2026-07-10, V249 — `main` @ tip)
...
- **Branch tip**: `MP_2026-07-10_V12` == `main` (V249). Convention: every commit gets an `MP_<date>_V<N>` branch AND `main` fast-forwarded to it; push both immediately.
