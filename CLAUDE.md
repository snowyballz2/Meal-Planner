...
## Current State (2026-07-11, V265 — `main` @ tip)
...
- **Branch tip**: `MP_2026-07-11_V13` == `main` (V265). Convention: every commit gets an `MP_<date>_V<N>` branch AND `main` fast-forwarded to it; push both immediately.
