...
## Current State (2026-07-11, V257 — `main` @ tip)
...
- **Branch tip**: `MP_2026-07-11_V5` == `main` (V257). Convention: every commit gets an `MP_<date>_V<N>` branch AND `main` fast-forwarded to it; push both immediately.
