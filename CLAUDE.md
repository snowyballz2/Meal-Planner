...
## Current State (2026-07-18, V280 — AUDIT ROUND 15 CLOSED — `main` @ tip)
...
- **Branch tip**: `MP_2026-07-18_V6` == `main` (V280). Convention: every commit gets an `MP_<date>_V<N>` branch AND `main` fast-forwarded to it; push both immediately.
