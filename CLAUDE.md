...
## Current State (2026-07-18, V279 — Audit R15 CRITICALs + ALL MEDIUMs closed; LOW sweep pending — `main` @ tip)
...
- **Branch tip**: `MP_2026-07-18_V5` == `main` (V279). Convention: every commit gets an `MP_<date>_V<N>` branch AND `main` fast-forwarded to it; push both immediately.
