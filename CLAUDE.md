...
## Current State (2026-07-09, V237 — `main` @ tip)

- **Quality (100-seed Test 1 + Test 2, V237)**: primary ~**99.7%** deterministic / ~99.5% nondeterministic (misses are the usual borderline proPct 40–42% / veg 2.75–3.0c classes; V237's Wave B traded −0.15pp vs V236 for honest waste accounting + phantom-INV14 elimination — see the V237 bullet); hard INVs (1–5, 7–13, 17, 19, 20-hard, 23–26) **all 0**; INV14 **0**; zero-waste (non-soft) 100%, soft fires ~8/100 runs (M11b tiebreaker); meals closed-off **0.0%**; per-click ~600 ms–1.5 s on a fresh process.
...
- **Branch tip**: `MP_2026-07-09_V4` == `main` (V237). Convention: every commit gets an `MP_<date>_V<N>` branch AND `main` fast-forwarded to it; push both immediately.
