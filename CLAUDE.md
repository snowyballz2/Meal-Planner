...
## Current State (2026-07-18, V277 + Audit R15 fixes in progress — `main` @ tip)
...
- **Branch tip**: `MP_2026-07-18_V3` == `main` (V277). Convention: every commit gets an `MP_<date>_V<N>` branch AND `main` fast-forwarded to it; push both immediately.
