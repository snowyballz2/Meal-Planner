...
## Current State (2026-07-09, V234 — `main` @ tip)
...
- **Branch tip**: `MP_2026-07-09_V1` == `main` (V234). Convention: every commit gets an `MP_<date>_V<N>` branch AND `main` fast-forwarded to it; push both immediately.
