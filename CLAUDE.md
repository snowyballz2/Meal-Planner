...
## Current State (2026-07-10, V250 — `main` @ tip)
...
- **Branch tip**: `MP_2026-07-10_V13` == `main` (V250). Convention: every commit gets an `MP_<date>_V<N>` branch AND `main` fast-forwarded to it; push both immediately.
