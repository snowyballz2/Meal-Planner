...
## Current State (2026-07-09, V236 — `main` @ tip)
...
- **Branch tip**: `MP_2026-07-09_V3` == `main` (V236). Convention: every commit gets an `MP_<date>_V<N>` branch AND `main` fast-forwarded to it; push both immediately.
