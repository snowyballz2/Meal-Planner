...
## Current State (2026-07-08, V233 — `main` @ tip)
...
- **Branch tip**: `MP_2026-07-08_V1` == `main` (V233). Convention: every commit gets an `MP_<date>_V<N>` branch AND `main` fast-forwarded to it; push both immediately.
