...
## Current State (2026-07-18, V275 + Audit R15 fixes in progress — `main` @ tip)
...
- **Branch tip**: `MP_2026-07-18_V2` == `main` (V276). Convention: every commit gets an `MP_<date>_V<N>` branch AND `main` fast-forwarded to it; push both immediately.
