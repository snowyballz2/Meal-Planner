...
- **Branch tip**: `MP_2026-06-09_V2` == `main` (project relocated to `~/Developer/Meal Planner` 2026-06-09; last app-version branch `MP_2026-06-02_V2` == V231). Convention: every commit gets an `MP_<date>_V<N>` branch AND `main` fast-forwarded to it; push both immediately.
