# CLAUDE.md — Archived Session Logs (2026-04-17 → 2026-05-05)

Moved out of CLAUDE.md on 2026-05-30 to keep the always-loaded project doc lean
(CLAUDE.md had grown to 256 KB / ~65K tokens, 87% of it this changelog).
These are the verbatim session notes for that span. The CURRENT architecture
reference lives in CLAUDE.md; the current distilled detail lives in the
~/.claude/projects/-Users-chris-Desktop-Meal-Planner/memory/ topic files.
